  ...
  return (
    <div style={{ position: "relative", width: "100%", background: "#080808" }}>
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
        ...
        <Link to="/networking/eventos" style={{ position: "absolute", left: x(1112), top: y(150), width: w(75), height: h(35), pointerEvents: "auto", display: "block" }} aria-label="Networking" />
        <NavDropdown ariaLabel="Mais opções de Networking" items={[{ label: "Eventos", to: "/networking/eventos" }, { label: "Grupos", to: "/networking/grupos" }, { label: "Empresas", to: "/networking/empresas" }]}
          triggerStyle={{ position: "absolute", left: x(1187), top: y(150), width: w(40), height: h(35) }}
